...
public class CdcChangeTest {
    ...
    public void update() throws IOException {
        assertThat(cdcChange.toTelegraf("{\n" +
                ...
                "      \"ts_ms\": 1520202662784\n" +
                "   }\n" +
                "}")).isEqualTo("cdc,table=Team,operation=update,id=60,id=true nbChanges=1");
    }
    ...
    public void delete() {
        assertThat(cdcChange.toTelegraf("{\n" +
                ...
                "      \"ts_ms\": 1520202505258\n" +
                "   }\n" +
                "}\n")).isEqualTo("cdc,table=Team,operation=delete,id=46");
    }
    ...
    public void insert() {
        assertThat(cdcChange.toTelegraf("{\n" +
                ...
                "      \"ts_ms\": 1520202543833\n" +
                "   }\n" +
                "}")).isEqualTo("cdc,table=Team,operation=create,id=57");
    }
}
